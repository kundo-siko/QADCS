 ...
 <div class="col-md-5 order-md-2 mb-4">
        ...
        <div class="col-md-5 mb-3">
           <h6>EMPLOYEE NO:</h6>
			...
			<div class="col-md-7 mb-3">
				...
				<!-- Hidden -->
				<input type="text" class="form-control" name="i" id="i" value="0" hidden>
  ...
  <div class="col-md-7 order-md-1">
		...
		<div class="row">
			...
			<div class="col-md-8 mb-3">
				<input type="text" class="form-control" id="other_names" name="other_names"  placeholder="" required>
					<div class="invalid-feedback">
						Valid last name is required.
					</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-8 mb-3">
				<input type="text" class="form-control" name="job_spec" id="job_spec" placeholder="" required>
					<div class="invalid-feedback">
						Valid last name is required.
					</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-8 mb-3">
				<input type="text" class="form-control" name="job_title" id="job_title" placeholder="" required>
					<div class="invalid-feedback">
						Valid last name is required.
					</div>
			</div>
